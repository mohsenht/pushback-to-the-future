...
from constants import CONFIG_COLUMN_ARRIVAL_RUNWAYS, CONFIG_COLUMN_DEPARTURE_RUNWAYS
...
class RunningRunwayInfoExtractor(FeatureExtractor):
    ...
    def fill_runways_for_each_flight(self, x, now_running_runway):
        departure_runways = now_running_runway[CONFIG_COLUMN_DEPARTURE_RUNWAYS].split(', ')
        arrival_runways = now_running_runway[CONFIG_COLUMN_ARRIVAL_RUNWAYS].split(', ')
